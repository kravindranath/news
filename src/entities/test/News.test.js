...
describe('Entity News: ', function () {
    ...
    it('should create with all props', function () {
        ...
        let mockData = {
            ...
            'author': 'Sky',
            'title': 'What we know about the three-tier COVID-19 restrictions - Sky News',
            'description': 'Test',
            'url': 'https://news.sky.com/story/what-we-know-about-the-three-tier-covid-19-restrictions-12102221',
            'urlToImage': 'https://e3.365dm.com/20/09/1600x900/skynews-graphic-pub-curfew_5112627.jpg?20200929110143',
            'publishedAt': '2020-10-12T03:11:15Z',
            'content': null
        };

        let news = new News(mockData);
